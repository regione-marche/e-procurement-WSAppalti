...
public interface ImpreseDao {
    ...
    /**
	 * Verifica l'esistenza di un'impresa attiva sul portale con lo stesso codice
	 * fiscale o partita di quelli in input. La partita IVA viene controllata anche
	 * con il campo codice fiscale nel DB in quanto tale informazione pu&ograve;
	 * essere sia un codice fiscale che una partita iva.
	 * 
	 * @param codiceFiscale codice fiscale da cercare
	 * @param partitaIva    partita iva da cercare
	 * @param isGruppoIva   true se si tratta di impresa appartenente a gruppo IVA,
	 *                      false altrimenti
	 * @return true se esiste almeno un'impresa attiva sul portale e che usa codice
	 *         fiscale o partita in input, false altrimenti
	 * @throws DataAccessException
	 */
    Boolean isImpresaRegistrata(String codiceFiscale, String partitaIva, boolean isGruppoIva)
	    throws DataAccessException;
	...
	VendorRatingType getVendorRatingValidita(String tokenRichiedente, Date data) throws DataAccessException, SqlComposerException;

	VendorRatingType getVendorRatingSospensione(String tokenRichiedente, Date data) throws DataAccessException, SqlComposerException;
}
