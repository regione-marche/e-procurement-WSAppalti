...
public class CataloghiManager {
	...
	private static final Logger logger = LoggerFactory.getLogger(CataloghiManager.class);
	...
	public List<BandoIscrizioneType> searchCataloghi(String token, Integer stato,
			String stazioneAppaltante, Boolean isAttivo) {
		return this.bandiDao.searchBandiIscrizione(token, GENERE_CATALOGO,
												   stato, stazioneAppaltante, isAttivo);
	}

	public List<BandoIscrizioneType> getElencoCataloghi(String stazioneAppaltante, Boolean isAttivo) {
		return this.bandiDao.getElencoBandiIscrizione(GENERE_CATALOGO, stazioneAppaltante, isAttivo);
	}
	...
	public List<DocumentoAllegatoType> getDocumentiArticolo(long id, int tipoDoc) {
		return this.cataloghiDao.getDocumentiArticolo(id, tipoDoc);
	}
