...
public interface BandiDao {
	 ...
	 */
	List<GaraType> searchBandi(GaraTypeSearch filtri) throws DataAccessException, SqlComposerException;
	
	int countBandi(GaraTypeSearch filtri) throws DataAccessException, SqlComposerException;
...
//	List<GaraType> getElencoBandi() throws DataAccessException;
	 ...
	 * @throws DataAccessException
	 */
	List<GaraType> getElencoBandi(GaraTypeSearch filtri) throws DataAccessException, SqlComposerException;

	int countElencoBandi(GaraTypeSearch filtri)	throws DataAccessException, SqlComposerException;
...
//	List<GaraType> getElencoBandiScaduti(int numAnniPubblicazione) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	 */
	List<GaraType> getElencoBandiScaduti(GaraTypeSearch filtri)	throws DataAccessException, SqlComposerException;
	
	int countElencoBandiScaduti(GaraTypeSearch filtri) throws DataAccessException, SqlComposerException;
	 ...
	 * @throws DataAccessException
	 */
	List<LottoGaraType> getLottiGaraPerDomandePartecipazione(String codiceGara, String progressivoOfferta);
     ...
     *
     * @param genere   10=bando d'iscrizione, 20=catalogo
     * @param isAttivo
     * @return lista dei bandi, di tipo {@link BandoIscrizioneType}
     * @throws DataAccessException
     */
	List<BandoIscrizioneType> getElencoBandiIscrizione(int genere, String stazioneAppaltante, Boolean isAttivo)
			throws DataAccessException;
	 ...
	 *            o del catalogo
	 * @param entita
	 * 			  codice dell'entita' associata alla comunicazione (TORN, GARECONT, G1STIPULA, APPA, etc...)
	 * @param indicePrimoRecord
	 * @param maxNumRecord
	 * 
	 * @return lista delle comunicazioni personali, di tipo
	 ...
	 * @throws DataAccessException
	 */
	List<ComunicazioneType> getComunicazioniInviate(
			String username,
			String codice, 
			String entita,
			int indicePrimoRecord, int maxNumRecord,
	 ...
	 */
	ComunicazioneType getComunicazioneRicevuta(String username, Long id, Long idDestinatario, String idprg);
	 ...
	 * @return dettaglio comunicazione
	 */
	ComunicazioneType getComunicazioneInviata(String username, Long id, String idprg);
...
//			throws DataAccessException;
	 ...
	 * @return lista dei bandi, di tipo {@link GaraType}
	 */
	List<GaraType> getElencoBandiPerRichiesteOfferta(GaraTypeSearch filtri)	throws DataAccessException, SqlComposerException;
	
	int countElencoBandiPerRichiesteOfferta(GaraTypeSearch filtri) throws DataAccessException, SqlComposerException;
...
//			throws DataAccessException;
	 ...
	 * @return lista dei bandi, di tipo {@link GaraType}
	 */
	List<GaraType> getElencoBandiPerRichiesteCheckDocumentazione(GaraTypeSearch filtri)	throws DataAccessException, SqlComposerException;
	
	int countElencoBandiPerRichiesteCheckDocumentazione(GaraTypeSearch filtri) throws DataAccessException, SqlComposerException;
	 ...
	 * @return lista dei bandi, di tipo {@link GaraType}
	 */
	List<GaraType> getElencoBandiPerAsteInCorso(GaraTypeSearch filtri) throws DataAccessException, SqlComposerException;
	 ...
	 * @return lista dei bandi, di tipo {@link GaraType}
	 */
	int countBandiPerAsteInCorso(GaraTypeSearch filtri)	throws DataAccessException, SqlComposerException;
	 ...
	 * @throws SqlComposerException
	 */
	List<GaraType> searchBandiPerProcInAggiudicazione(GaraTypeSearch filtri) throws DataAccessException, SqlComposerException;
	
	int countBandiPerProcInAggiudicazione(GaraTypeSearch filtri) throws DataAccessException, SqlComposerException;
	 ...
	 * @throws SqlComposerException
	 */
	List<GaraType> searchBandiConEsito(GaraTypeSearch filtri) throws DataAccessException, SqlComposerException;
	
	int countBandiConEsito(GaraTypeSearch filtri) throws DataAccessException, SqlComposerException;
	 ...
	 * @param genere   10=bando d'iscrizione, 20=catalogo
	 * @param stato    eventuale stato su cui filtrare
	 * @param isAttivo
	 * @return lista dei bandi, di tipo {@link BandoIscrizioneType}
	 * @throws DataAccessException
	 */
	List<BandoIscrizioneType> searchBandiIscrizione(String username,
													int genere, Integer stato, String stazioneAppaltante, Boolean isAttivo) throws DataAccessException;
	...
	/**
	 * recupera il questionario associato alla gara/elenco
	 */
	...
	/**
	 * recupera i parametri del questionario
	 */
