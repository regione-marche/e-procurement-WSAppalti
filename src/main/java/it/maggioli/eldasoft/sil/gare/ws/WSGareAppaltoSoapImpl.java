...
public class WSGareAppaltoSoapImpl implements WSGareAppaltoSoap {
	...
	private static final Logger LOG = Logger.getLogger(WSGareAppaltoSoapImpl.class.getName());
	...
	public void setBandiManager(BandiManager bandiManager) {
		this.bandiManager = bandiManager;
	}

	public void setEsitiManager(EsitiManager esitiManager) {
	...
	public void setImpreseGaraManager(ImpreseManager impreseGaraManager) {
		this.impreseGaraManager = impreseGaraManager;
	}

	public void setCataloghiManager(CataloghiManager cataloghiManager) {
	...
	@Override
	public ElencoBandiOutType searchBandi(
	...
	{
		if (LOG.isDebugEnabled())
			LOG.debug("searchBandi(" + stazioneAppaltante + "," + oggetto + ","
					+ cig + "," + tipoAppalto + "," + dataPubblicazioneDa + ","
					+ dataPubblicazioneA + "," + "," + dataScadenzaDa + ","
					+ dataScadenzaA + "," + proceduraTelematica + "," + stato + ","
					+ numAnniPubblicazione + "," + altriSoggetti + "," 
					+ sommaUrgenza + "): inizio metodo");

		ElencoBandiOutType risultato = new ElencoBandiOutType();

		try {
			int count = this.bandiManager.countBandi(
					stazioneAppaltante, 
					oggetto, 
					cig, 
					tipoAppalto,
			...
			List<GaraType> listaGare = this.bandiManager.searchBandi(
					stazioneAppaltante, 
					oggetto, 
					cig, 
					tipoAppalto,
	...
	@Override
	public ElencoBandiOutType getElencoBandi(
			String stazioneAppaltante,
			String oggetto, 
			String cig, 
			String tipoAppalto,
	...
	{
		if (LOG.isDebugEnabled()) {
			LOG.debug("elencoBandi(" + stazioneAppaltante + ","
					+ oggetto + "," + cig + "," + tipoAppalto + ","
					+ dataPubblicazioneDa + "," + dataPubblicazioneA + ","
					+ dataScadenzaDa + "," + dataScadenzaA + ","
					+ proceduraTelematica + "," + stato + "," 
					+ altriSoggetti + "," + sommaUrgenza + "): inizio metodo");
		}

		ElencoBandiOutType risultato = new ElencoBandiOutType();

		try {
			int count = this.bandiManager.countElencoBandi(
					stazioneAppaltante, 
					oggetto, 
					cig, 
					tipoAppalto,
			...
			List<GaraType> listaGare = this.bandiManager.getElencoBandi(
					stazioneAppaltante, 
					oggetto, 
					cig, 
					tipoAppalto,
	...
	@Override
	public ElencoBandiOutType getElencoBandiPrivatistiche(
			String stazioneAppaltante,
			String oggetto, 
			String cig, 
			String tipoAppalto,
	...
	{
		if (LOG.isDebugEnabled()) {
			LOG.debug("elencoBandiPrivatistiche(" + stazioneAppaltante + ","
					+ oggetto + "," + cig + "," + tipoAppalto + ","
					+ dataPubblicazioneDa + "," + dataPubblicazioneA + ","
					+ dataScadenzaDa + "," + dataScadenzaA + ","
					+ proceduraTelematica + "," + stato + "," + altriSoggetti + "," 
					+ sommaUrgenza + "," + garaPrivatistica + "): inizio metodo");
		}
	...
	{
		if (LOG.isDebugEnabled()) {
			LOG.debug("elencoBandiScaduti(" + stazioneAppaltante + ","
					+ oggetto + ", " + cig + "," + tipoAppalto + ","
					+ dataPubblicazioneDa + "," + dataPubblicazioneA + ","
					+ dataScadenzaDa + "," + dataScadenzaA + ","
					+ proceduraTelematica + "," + stato + "," + esito + ","
					+ altriSoggetti + "," + sommaUrgenza + "," + numAnniPubblicazione 
					+ "): inizio metodo");
		}
		ElencoBandiOutType risultato = new ElencoBandiOutType();

		try {
			int count = this.bandiManager.countElencoBandiScaduti(
					stazioneAppaltante,
					oggetto, 
					cig, 
					tipoAppalto,
	...
	{
		if (LOG.isDebugEnabled()) {
			LOG.debug("elencoBandiScadutiPrivatistiche(" + stazioneAppaltante + ","
					+ oggetto + ", " + cig + "," + tipoAppalto + ","
					+ dataPubblicazioneDa + "," + dataPubblicazioneA + ","
					+ dataScadenzaDa + "," + dataScadenzaA + ","
					+ proceduraTelematica + "," + stato + "," + esito + ","
					+ altriSoggetti + "," + sommaUrgenza + "," + garaPrivatistica + "," 
					+ numAnniPubblicazione 
					+ "): inizio metodo");
		}
		ElencoBandiOutType risultato = new ElencoBandiOutType();
...
//				List<String> istruttori = this.bandiManager.getPuntiIstruttori(codiceGara);				
				...
				List<ComunicazioneType> comunicazioni = this.bandiManager
						.getComunicazioniPubbliche(codiceGara, null);
				...
				List<ComunicazioneLotto> lottiComunicazioni = this.bandiManager
					.getLottiComunicazioniPubbliche(codiceGara, codiceStazioneAppaltante);
	...
	public LottiGaraOutType getLottiGaraPerDomandePartecipazione(
		...
		try {
			List<LottoGaraType> lotti = this.bandiManager
					.getLottiGaraPerDomandePartecipazione(codiceGara);
	...
	@Override
	public ElencoEsitiOutType searchEsiti(
			String stazioneAppaltante,
			String oggetto, 
			String cig, 
			String tipoAppalto,
	...
	{
		if (LOG.isDebugEnabled())
			LOG.debug("searchEsiti(" + stazioneAppaltante + "," + oggetto + ","
					+ cig + "," + tipoAppalto + "," + dataPubblicazioneDa + ","
					+ dataPubblicazioneA + "," + proceduraTelematica + ","
					+ altriSoggetti + "," + sommaUrgenza + "," +
					+ numAnniPubblicazione + "): inizio metodo");

		ElencoEsitiOutType risultato = new ElencoEsitiOutType();

		try {
			int count = this.esitiManager.countEsiti(
					stazioneAppaltante, 
					oggetto, 
					cig, 
					tipoAppalto,
			...
			List<EsitoType> listaEsiti = this.esitiManager.searchEsiti(
					stazioneAppaltante, 
					oggetto, 
					cig, 
					tipoAppalto,
	...
	{
		if (LOG.isDebugEnabled())
			LOG.debug("elencoEsiti(" + stazioneAppaltante + "," + oggetto + ","
					+ cig + "," + tipoAppalto + "," + dataPubblicazioneDa + ","
					+ dataPubblicazioneA + "," + proceduraTelematica + ","
					+ altriSoggetti + "," + sommaUrgenza + ","
					+ numAnniPubblicazione + "): inizio metodo");
		...
		try {
			int count = this.esitiManager.countElencoEsiti(
					stazioneAppaltante, 
					oggetto, 
					cig, 
					tipoAppalto, 
			...
			List<EsitoType> listaEsiti = this.esitiManager.getElencoEsiti(
					stazioneAppaltante, 
					oggetto, 
					cig, 
					tipoAppalto, 
	...
	@Override
	public ElencoEsitiOutType getElencoEsitiAffidamenti(
			String stazioneAppaltante,
			String oggetto, 
			String cig, 
			String tipoAppalto,
	...
	{
		if (LOG.isDebugEnabled())
			LOG.debug("elencoEsitiAffidamento(" + stazioneAppaltante + "," + oggetto + ","
					+ cig + "," + tipoAppalto + "," + dataPubblicazioneDa + ","
					+ dataPubblicazioneA + "," + proceduraTelematica + ","
					+ altriSoggetti + "," + sommaUrgenza + ","
					+ numAnniPubblicazione + "): inizio metodo");
		...
		try {
			int count = this.esitiManager.countElencoEsitiAffidamenti(
					stazioneAppaltante, 
					oggetto, 
					cig, 
					tipoAppalto, 
			...
			List<EsitoType> listaEsiti = this.esitiManager
					.getElencoEsitiAffidamenti(
							stazioneAppaltante, 
							oggetto, 
							cig, 
							tipoAppalto, 
	...
	public DettaglioEsitoOutType getDettaglioEsito(String codiceGara) {
		...
		try {
			...
			for (int i = 0; i < lotti.size(); i++) {
				...
				documentiLotto = lotto.getDocumento();
				if("4".equalsIgnoreCase(lotti.get(i).getGruppo())) {
	...
	@Override
	public ElencoAvvisiOutType searchAvvisi(String stazioneAppaltante,
			String oggetto, String tipoAvviso, 
			Date dataPubblicazioneDa,
			Date dataPubblicazioneA, 
			Date dataScadenzaDa, 
			Date dataScadenzaA,
	...
	{
		if (LOG.isDebugEnabled())
			LOG.debug("searchAvvisi(" + stazioneAppaltante + "," + oggetto + "," 
					+ tipoAvviso + "," + dataPubblicazioneDa + ","
					+ dataPubblicazioneA + "," + dataScadenzaDa + ","
					+ dataScadenzaA + "," + altriSoggetti + "," + numAnniPubblicazione + 
					"): inizio metodo");

		ElencoAvvisiOutType risultato = new ElencoAvvisiOutType();

		try {
			int count = this.avvisiManager.countAvvisi(
					stazioneAppaltante, 
					oggetto, 
					tipoAvviso,
					dataPubblicazioneDa, dataPubblicazioneA, 
			...
			List<AvvisoType> listaAvvisi = this.avvisiManager.searchAvvisi(
					stazioneAppaltante, 
					oggetto, 
					tipoAvviso,
					dataPubblicazioneDa, dataPubblicazioneA, 
	...
	@Override
	public ElencoAvvisiOutType getElencoAvvisi(
			String stazioneAppaltante,
			String oggetto, 
			String tipoAvviso, 
			Date dataPubblicazioneDa, Date dataPubblicazioneA, 
	...
	{
		if (LOG.isDebugEnabled()) {
			LOG.debug("elencoAvvisi(" + stazioneAppaltante + ","
					+ oggetto + "," + tipoAvviso + ","
					+ dataPubblicazioneDa + "," + dataPubblicazioneA + ","
					+ dataScadenzaDa + "," + dataScadenzaA + "," + altriSoggetti +
					"): inizio metodo");
		}
		...
		try {
			int count = this.avvisiManager.countElencoAvvisi(
					stazioneAppaltante, 
					oggetto, 
					tipoAvviso,
					dataPubblicazioneDa, dataPubblicazioneA, 
			...
			List<AvvisoType> listaAvvisi = this.avvisiManager.getElencoAvvisi(
					stazioneAppaltante, 
					oggetto, 
					tipoAvviso,
					dataPubblicazioneDa, dataPubblicazioneA, 
	...
	@Override
	public ElencoAvvisiOutType getElencoAvvisiScaduti(
			String stazioneAppaltante,
			String oggetto, String tipoAvviso, 
			Date dataPubblicazioneDa,
			Date dataPubblicazioneA, 
	...
	{
		if (LOG.isDebugEnabled()) {
			LOG.debug("elencoAvvisiScaduti(" + stazioneAppaltante + ","
					+ oggetto + "," + tipoAvviso + "," + dataPubblicazioneDa
					+ "," + dataPubblicazioneA + "," + dataScadenzaDa + ","
					+ dataScadenzaA + "," + altriSoggetti + "," + numAnniPubblicazione
					+ "): inizio metodo");
		}
		...
		try {
			int count = this.avvisiManager.countElencoAvvisiScaduti(
					stazioneAppaltante, 
					oggetto, 
					tipoAvviso,
					dataPubblicazioneDa, dataPubblicazioneA, 
			...
			List<AvvisoType> listaAvvisi = this.avvisiManager.getElencoAvvisiScaduti(
					stazioneAppaltante, 
					oggetto, 
					tipoAvviso,
					dataPubblicazioneDa, dataPubblicazioneA, 
	...
	public DettaglioAvvisoOutType getDettaglioAvviso(String codiceGara) {
		...
		try {
			...
			List<SoggettoAderenteType> soggettiAderenti = this.bandiManager
					.getSoggettiAderenti(codiceGara);
			List<ComunicazioneType> comunicazioni = this.bandiManager
					.getComunicazioniPubbliche(codiceGara, codiceStazioneAppaltante);
	...
	public ElencoBandiIscrizioneOutType searchBandiIscrizione(String token,
		...
		try {
			List<BandoIscrizioneType> listaBandi = this.bandiManager
					.searchBandiIscrizione(token, stato, stazioneAppaltante);
	...
	@Override
	public ElencoBandiIscrizioneOutType getElencoBandiIscrizione(String stazioneAppaltante) {
		if (LOG.isDebugEnabled())
		...
		try {
			List<BandoIscrizioneType> listaBandi = this.bandiManager
					.getElencoBandiIscrizione(stazioneAppaltante);
			risultato.setElencoBandiIscrizione(listaBandi);
			risultato.setNumBandi(listaBandi.size());
		} catch (DataAccessException e) {
			LOG.error(
	...
	public DettaglioBandoIscrizioneOutType getDettaglioBandoIscrizione(
		...
		try {
			...
			if (datiGeneraliBando != null) {
				...
				List<ComunicazioneType> comunicazioni = this.bandiManager
						.getComunicazioniPubbliche(codiceBandoIscrizione, stazioneAppaltante);
	...
	public GetStatisticheComunicazioniPersonaliOutType getStatisticheComunicazioniPersonali(
			String tokenRichiedente, String codice, String stazioneAppaltante) {
		if (LOG.isDebugEnabled()) {
		...
		try {
			risultato.setStatistiche(this.bandiManager
					.getStatisticheComunicazioniPersonali(tokenRichiedente, codice, 
							stazioneAppaltante));
		} catch (DataAccessException e) {
			LOG.error(
					"Errore inaspettato durante l'interazione con la base dati",
	...
	public GetStatisticheComunicazioniPersonaliOutType getStatisticheComunicazioniPersonaliGaraLotti(
			String tokenRichiedente, String codiceGara, String stazioneAppaltante) {
		if (LOG.isDebugEnabled()) {
			LOG.debug("getStatisticheComunicazioniPersonaliGaraLotti(" + tokenRichiedente + ","
					+ codiceGara + "," + stazioneAppaltante
					+ "): inizio metodo");
		}
		...
		try {
			risultato.setStatistiche(this.bandiManager
					.getStatisticheComunicazioniPersonaliGaraLotti(tokenRichiedente, codiceGara, 
							stazioneAppaltante));
		} catch (DataAccessException e) {
			LOG.error(
					"Errore inaspettato durante l'interazione con la base dati",
	...
	public ComunicazioniPersonaliOutType getComunicazioniPersonaliRicevute(
			...
			String stazioneAppaltante) {
		if (LOG.isDebugEnabled()) {
			LOG.debug("getComunicazioniPersonaliRicevute(" + tokenRichiedente + ","
					+ codice + "," + soccorsoIstruttorio + "," 
					+ indicePrimoRecord + "," + maxNumRecord + ","
					+ maxNumRecord + "," + stazioneAppaltante
					+ "): inizio metodo");
		}
	...
	{
		if (LOG.isDebugEnabled()) {
			LOG.debug("getComunicazioniPersonaliRicevuteGaraLotti(" + tokenRichiedente + ","
					+ codiceGara + "," + indicePrimoRecord + "," + maxNumRecord + ","
					+ stazioneAppaltante
					+ "): inizio metodo");
		}
		...
		try {
			...
			risultato.setNumElementiTotali(this.bandiManager
					.countComunicazioniRicevuteGaraLotti(tokenRichiedente, codiciLotto, false,  
							stazioneAppaltante));
			if (risultato.getNumElementiTotali() > 0) {
				List<ComunicazioneType> comunicazioni = this.bandiManager
	...
	{
		if (LOG.isDebugEnabled()) {
			LOG.debug("getComunicazioniPersonaliArchiviate(" + tokenRichiedente + ","
					+ codice + "," + soccorsoIstruttorio + "," 
					+ indicePrimoRecord + "," + maxNumRecord + ","
					+ stazioneAppaltante
					+ "): inizio metodo");
	...
	{
		if (LOG.isDebugEnabled()) {
			LOG.debug("getComunicazioniPersonaliArchiviateGaraLotti(" + tokenRichiedente + ","
					+ codiceGara + "," + soccorsoIstruttorio + "," 
					+ indicePrimoRecord + "," + maxNumRecord + ","
					+ stazioneAppaltante
					+ "): inizio metodo");
		}
			...
			String stazioneAppaltante) 
	{
		...
		try {
			risultato.setNumElementiTotali(this.bandiManager
					.countComunicazioniInviate(tokenRichiedente, codice, stazioneAppaltante));
			if (risultato.getNumElementiTotali() > 0) {
				List<ComunicazioneType> comunicazioni = this.bandiManager
	...
	public ComunicazionePersonaleOutType getComunicazionePersonaleRicevuta(
			String tokenRichiedente, long idComunicazione, long idDestinatario) {
		if (LOG.isDebugEnabled()) {
	...
	public ComunicazionePersonaleOutType getComunicazionePersonaleInviata(
			String tokenRichiedente, long idComunicazione) {
		if (LOG.isDebugEnabled()) {
	...
	public GetDatiImpresaOutType getDatiImpresa(String token, Date dataPartenzaCessati) {
		...
		try {
			...
			LOG.error(
					"Errore inaspettato durante l'estrazione dei dati dell'impresa per l'iscrizione",
					e);
			risultato.setErrore(e.getMessage());
		}
	...
	private boolean checkValidazione(XmlObject oggetto, String tag) {
		...
		if (!esitoCheckSintassi) {
			...
			for (int i = 0; i < validationErrors.size(); i++) {
				if (validationErrors.get(i).getOffendingQName() != null)
					sb.append(
							validationErrors.get(i).getOffendingQName()
									.getLocalPart()).append(": ");
				sb.append(validationErrors.get(i).getMessage()).append("\n");
			}
	...
	{
		if (LOG.isDebugEnabled()) {
			LOG.debug("elencoBandiPerRichiesteOfferta(" + tokenRichiedente
					+ "," + stazioneAppaltante + "," + oggetto + "," + cig
					+ "," + tipoAppalto + "," + dataPubblicazioneDa + ","
					+ dataPubblicazioneA + "," + dataScadenzaDa + ","
					+ dataScadenzaA + "," + proceduraTelematica  + "," + stato + "," 
					+ sommaUrgenza + "," + altriSoggetti
					+ "): inizio metodo");
		}
		...
		try {
			int count = this.bandiManager.countElencoBandiPerRichiesteOfferta(
					tokenRichiedente,
					stazioneAppaltante, 
					oggetto, 
					cig, 
			...
			List<GaraType> listaGare = this.bandiManager
					.getElencoBandiPerRichiesteOfferta(
							tokenRichiedente,
							stazioneAppaltante, 
							oggetto, 
							cig, 
	...
	{
		if (LOG.isDebugEnabled()) {
			LOG.debug("elencoBandiPerRichiesteOffertaPrivatistiche(" + tokenRichiedente
					+ "," + stazioneAppaltante + "," + oggetto + "," + cig
					+ "," + tipoAppalto + "," + dataPubblicazioneDa + ","
					+ dataPubblicazioneA + "," + dataScadenzaDa + ","
					+ dataScadenzaA + "," + proceduraTelematica  + "," + stato + "," 
					+ sommaUrgenza + "," + altriSoggetti + "," + garaPrivatistica  
					+ "): inizio metodo");
		}
	...
	@Override
	public ElencoBandiOutType getElencoBandiPerRichiesteCheckDocumentazione(
			String tokenRichiedente,
			String stazioneAppaltante,
			String oggetto, 
			String cig, 
	...
	{
		if (LOG.isDebugEnabled()) {
			LOG.debug("elencoBandiPerRichiesteCheckDocumentazione(" + tokenRichiedente + "," 
					+ stazioneAppaltante + "," + oggetto + "," + cig + "," 
					+ tipoAppalto + "," + dataPubblicazioneDa + ","
					+ dataPubblicazioneA + "," + dataScadenzaDa + ","
					+ dataScadenzaA + "," + proceduraTelematica + "," 
					+ stato + "," + altriSoggetti + "," + sommaUrgenza
					+ "): inizio metodo");
		}

		ElencoBandiOutType risultato = new ElencoBandiOutType();
		try {
			int count = this.bandiManager.countElencoBandiPerRichiesteCheckDocumentazione(
					tokenRichiedente,
					stazioneAppaltante, 
					oggetto, 
					cig, 
			...
			List<GaraType> listaGare = this.bandiManager
					.getElencoBandiPerRichiesteCheckDocumentazione(
							tokenRichiedente,
							stazioneAppaltante, 
							oggetto, 
							cig, 
	...
	{
		if (LOG.isDebugEnabled())
			LOG.debug("elencoBandiPerAsteInCorso(" + tokenRichiedente + "," + 
		...
		try {
			int count = this.bandiManager.countBandiPerAsteInCorso(
					tokenRichiedente,
					stazioneAppaltante, 
					oggetto, 
					cig, 
...
//			, Boolean sommaUrgenza
	...
	{
		if (LOG.isDebugEnabled())
			LOG.debug("countBandiPerAsteInCorso(" + tokenRichiedente
					+ "): inizio metodo");
		...
		try {
			int count = this.bandiManager.countBandiPerAsteInCorso(
							...
							cig, 
							tipoAppalto,							
							// Attenzione: dataPubblicazioneDa e dataPubblicazioneA non vengono utilizzate !!! 
							dataPubblicazioneDa, dataPubblicazioneA, 
							dataScadenzaDa, dataScadenzaA, 
							proceduraTelematica, 
							stato,
	...
	public EsitoOutType isImpresaRegistrata(String codiceFiscale,
			String partitaIva) {
		if (LOG.isDebugEnabled())
			LOG.debug("impresaRegistrata(" + codiceFiscale + ","
					+ partitaIva + "): inizio metodo");

		EsitoOutType risultato = new EsitoOutType();

		try {
			Boolean impresaRegistrata = this.impreseGaraManager
					.isImpresaRegistrata(codiceFiscale, partitaIva);
		...
		if (LOG.isDebugEnabled())
			LOG.debug("impresaRegistrata: fine metodo");
	...
	@Override
	public ElencoBandiOutType searchBandiPerProcInAggiudicazione(
	...
	{
		if (LOG.isDebugEnabled())
			LOG.debug("searchBandiPerProcInAggiudicazione("
					+ tokenRichiedente + "," + stazioneAppaltante + "," 
					+ oggetto + "," + cig + "," + tipoAppalto + "," 
					+ dataPubblicazioneDa + "," + dataPubblicazioneA + "," + dataScadenzaDa + ","
					+ dataScadenzaA + "," + proceduraTelematica + "," + stato + "," + esito + "," 
					+ altriSoggetti + "," + sommaUrgenza
					+ "): inizio metodo");

		ElencoBandiOutType risultato = new ElencoBandiOutType();
		try {
			int count = this.bandiManager.countBandiPerProcInAggiudicazione(
					tokenRichiedente,
					stazioneAppaltante,
					oggetto, 
					cig, 
			...
			List<GaraType> listaGare = this.bandiManager
					.searchBandiPerProcInAggiudicazione(
							tokenRichiedente,
							stazioneAppaltante,
							oggetto, 
							cig, 
	...
	@Override
	public ElencoBandiOutType searchBandiPerProcInAggiudicazionePrivatistiche(
            java.lang.String tokenRichiedente,
			String stazioneAppaltante,
			String oggetto, 
			String cig, 
	...
	{
		if (LOG.isDebugEnabled())
			LOG.debug("searchBandiPerProcInAggiudicazionePrivatistiche("
					+ tokenRichiedente + "," + stazioneAppaltante + "," 
					+ oggetto + "," + cig + "," + tipoAppalto + "," 
					+ dataPubblicazioneDa + "," + dataPubblicazioneA + "," + dataScadenzaDa + ","
					+ dataScadenzaA + "," + proceduraTelematica + "," + stato + "," + esito + "," 
	...
	{
		if (LOG.isDebugEnabled())
			LOG.debug("searchBandiConEsito(" + stazioneAppaltante + "," + oggetto + ","
					+ cig + "," + tipoAppalto + "," + dataPubblicazioneDa + ","
					+ dataPubblicazioneA + "," + "," + dataScadenzaDa + ","
					+ dataScadenzaA + "," + proceduraTelematica + "," + stato + "," 
					+ altriSoggetti + "," + sommaUrgenza + "," 
		...
		ElencoBandiOutType risultato = new ElencoBandiOutType();
		try {
			int count = this.bandiManager.countBandiConEsito(
					stazioneAppaltante, 
					oggetto, 
					cig, 
					tipoAppalto,
			...
			List<GaraType> listaGare = this.bandiManager.searchBandiConEsito(
					stazioneAppaltante, 
					oggetto, 
					cig, 
					tipoAppalto,
	...
	public ElencoBandiIscrizioneOutType searchCataloghi(String token,
		...
		try {
			List<BandoIscrizioneType> listaElementi = this.cataloghiManager
					.searchCataloghi(token, stato, stazioneAppaltante);
	...
	@Override
	public ElencoBandiIscrizioneOutType getElencoCataloghi(String stazioneAppaltante) {
		LOG.debug("elencoCataloghi(" + stazioneAppaltante + "): inizio metodo");

		ElencoBandiIscrizioneOutType risultato = new ElencoBandiIscrizioneOutType();
		try {
			List<BandoIscrizioneType> listaElementi = this.cataloghiManager
					.getElencoCataloghi(stazioneAppaltante);
			risultato.setElencoBandiIscrizione(listaElementi);
			risultato.setNumBandi(listaElementi.size());
		} catch (DataAccessException e) {
			LOG.error(
	...
	public GetArticoloOutType getArticolo(long id) {
		...
		try {
			...
			List<DocumentoAllegatoType> documenti = this.cataloghiManager
					.getDocumentiArticolo(id);

			risultato.setArticolo(dettaglio);
			dettaglio.setFacSimileCertificazioni(documenti);
