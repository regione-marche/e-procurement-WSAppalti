...
@XmlType(name = "GetElencoTipiClassificaOutType", propOrder = {
    "elenco",
    "errore"
})
public class GetElencoTipiClassificaOutType implements Serializable {
	
	/**
	 * UID
	 */
	private static final long serialVersionUID = 47838547637175035L;
