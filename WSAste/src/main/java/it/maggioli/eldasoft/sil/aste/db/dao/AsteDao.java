...
public interface AsteDao {
	 ...
	 * @param classificaAlRialzo
	 * 		se False estrae la classifica sui ribassi d'offerta
	 * 	    se True estrae la classifica sui rialzi d'offerta (NON GESTITA)
	 * 
	 * @return la lista della classifica
	 */
   	public List<DettaglioClassificaType> getClassifica(int tipoClassifica, String codice, String codiceLotto, String username, String numeroFase, boolean classificaAlRialzo) throws SqlComposerException;
